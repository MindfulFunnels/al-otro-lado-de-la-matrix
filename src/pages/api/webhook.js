      ...
      case "checkout.session.completed":
        ...
        try {
          ...
          const payload = {
            ...
            to: [{ email, name }],
            subject: `ACCESO A LA MAMBRESÍA AL OTRO LADO DE LA MATRIX - CAMBIA TU VIDA AHORA 🔥🎫`,
            htmlContent: `
          <!DOCTYPE html>
          <html lang="es">
            <head>
              ...
              <style>
                ...
                .discord-invite {
                  background: var(--color-primary); /* color estilo Discord */
                  padding: 20px;
                  border-radius: 10px;
                  color: #fff;
                  max-width: 400px;
            ...
            <body style="background-color: transparent; color:#000 !important;">
              <div class="container" style="background-color: transparent !important;">
                ...
                <h1 class="title">
                  AL OTRO LADO DE LA <span>MATRIX</span>
                </h1>
                ...
                <div style="color: #000 !important;">
                  ...
                  <p>
                    Gracias por unirte a <strong style="color: var(--color-primary) !important;">AL OTRO LADO DE LA <span style="color: var(--color-success) !important;">MATRIX</span></strong>.
                ...
                <div class="header">
                  ...
                  <p style="color: #000 !important;">
                    Nos vemos dentro<br />
                    <strong style="color: var(--color-primary) !important;">Luis Garre</strong>
                  </p>
                </div>
              </div>
            </body>
